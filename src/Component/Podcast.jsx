      ...
      <div className='hidden md:block py-20 px-8 lg:px-40 bg-black text-white '>
        ...
        <div className='mx-2 lg:mx-10 my-20 bg-white hover:scale-110 ease-in-out duration-300 h-80 lg:h-96 rounded-lg'>
            <div className='flex'>
                ...
                <a href="#"><Image src="/assets/Images/Podcast/Spotify.png" alt="" className='h-12 w-12' /></a>
                <a href="#"><Image src="/assets/Images/Podcast/ApplePodcast.png" alt="" className='h-12 w-12' /></a>     
                    </div>
                </div>
            </div>
          </div>
