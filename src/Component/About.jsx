              ...
              <div className='mx-10 my-20 bg-white hover:scale-110 ease-in-out duration-300 h-[360px] rounded-lg'>
                  <div className='flex'>
                      ...
                      <div className='flex-1 mx-6'>
                          <h1 className='text-black text-4xl mt-12'>About Boys Played Well</h1>
                          ...
                          <div className='flex gap-4 mt-2'>
                              <button className='h-10 btn w-40 mt-4 rounded hover:bg-blue-1 hover:font-bold hover:border-none text-white border border-white my-auto'>Know More</button>
                          </div>
                      </div>
                  </div>
              </div>
